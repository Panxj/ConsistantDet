...
from .py_utils.losses import CornerNet_Loss, CornerNet_Loss_DCN
...
class dcn_model(dcn_hg_net):
    ...
    def __init__(self):
        ...
        tl_modules = nn.ModuleList([DcnPool(256,128,0,(3,3),padding=1) for _ in range(stacks)])
        br_modules = nn.ModuleList([DcnPool(256,128,1,(3,3),padding=1) for _ in range(stacks)])
        ...
        self.loss = CornerNet_Loss_DCN(pull_weight=1e-1, push_weight=1e-1)
